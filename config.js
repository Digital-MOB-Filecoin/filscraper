module.exports = {
  scraper: {
    ...
    nova_api: process.env.SCRAPER_NOVA_API || "",
    nova_api_key: process.env.SCRAPER_NOVA_API_KEY || "",
    filinfo_api: process.env.FILINFO_API || "",
    disable_main_loop: process.env.SCRAPER_DISABLE_MAIN_LOOP || 0,
    skip_updating_views_on_cold_start:
      process.env.SCRAPER_SKIP_UPDATING_VIEWS_ON_COLD_START || 0,
  },
  database: {
