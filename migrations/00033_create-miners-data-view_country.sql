CREATE MATERIALIZED VIEW IF NOT EXISTS fil_miners_data_view_country
AS
with datapoints as (
                    SELECT
                    ...
                    left join fil_location_view ON fil_location_view.miner = fil_emissions_view.miner
                ),
                     data as (SELECT
                          miner,
                          country,
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_fil_miners_data_view_country ON fil_miners_data_view_country(miner, country, date);