CREATE MATERIALIZED VIEW IF NOT EXISTS fil_miners_data_view_country_v8
AS
with datapoints as (
SELECT
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_fil_miners_data_view_country_v8 ON fil_miners_data_view_country_v8(miner, date, country, region, city, renewable_energy_kW);