CREATE MATERIALIZED VIEW IF NOT EXISTS fil_miners_data_view_country_v6
AS
with datapoints as (
SELECT
                    ...
                    LEFT JOIN fil_renewable_energy_view_v5
                            ...
                            AND ((fil_renewable_energy_view_v5.country = fil_emissions_view_v4.country OR
                            EXISTS (SELECT 1 FROM fil_country_exceptions WHERE fil_country_exceptions.exception = fil_renewable_energy_view_v5.country AND fil_country_exceptions.country = fil_emissions_view_v4.country)))
                    LEFT JOIN (
                    ...
                    AND (fil_emissions_view_v4.country = location_count.country or EXISTS (SELECT 1 FROM fil_country_exceptions WHERE fil_country_exceptions.exception = fil_emissions_view_v4.country AND fil_country_exceptions.country = location_count.country))
                ),
                     data as (SELECT
                          miner,
                          country,
